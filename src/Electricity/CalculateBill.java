        ...
        if(ae.getSource() == b1){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    total_bill += Integer.parseInt(rs.getString("meter_rent")); //47
                    total_bill += Integer.parseInt(rs.getString("service_charge")); //22
                    total_bill += Integer.parseInt(rs.getString("service_tax"));  //57
                    total_bill += Integer.parseInt(rs.getString("swacch_bharat_cess")); //6
                    total_bill += Integer.parseInt(rs.getString("fixed_tax")); //18
                }
            }catch(Exception e){}
